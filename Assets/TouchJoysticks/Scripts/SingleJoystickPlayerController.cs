...
public class SingleJoystickPlayerController : MonoBehaviour
{
    ...
    Transform myRotationObject; // The object we will be rotating when moving
    ...
    Animator animator; // The animator for the toon. 

    // Use this for initialization
    void Start()
    {
      
      rigidBody = PlaceMultipleObjectsOnPlane.spawnedObject.GetComponent<Rigidbody>();
       ...
       myRotationObject = PlaceMultipleObjectsOnPlane.spawnedObject.transform.GetChild(0);
        ...
        animator = PlaceMultipleObjectsOnPlane.spawnedObject.GetComponentInChildren<Animator>();
